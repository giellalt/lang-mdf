...
This directory contains source files for the Moksha language morphology
and dictionary. The data and implementation are licenced under \_\_GNU
GPL\_\_ licence also detailed in the LICENCE file of this directory. The
...
In order to compile and use Moksha language morphology and dictionaries,
you need:
...
The Moksha language sources can be acquired using [giella SVN
